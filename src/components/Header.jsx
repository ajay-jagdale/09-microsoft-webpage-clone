                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-4">
                                    {/* Navigation links */}
                                    <a href="/microsoft-365" className="rounded-md px-3 py-2 text-sm" aria-current="page">Microsoft 365</a>
                                    <a href="/teams" className="rounded-md px-3 py-2 text-sm">Teams</a>
                                    <a href="/copilot" className="rounded-md px-3 py-2 text-sm">Copilot</a>
                                    <a href="/windows" className="rounded-md px-3 py-2 text-sm">Windows</a>
                                    <a href="/surface" className="rounded-md px-3 py-2 text-sm">Surface</a>
                                    <a href="/xbox" className="rounded-md px-3 py-2 text-sm">Xbox</a>
                                    <a href="/support" className="rounded-md px-3 py-2 text-sm">Support</a>
                                </div>
                            </div>
                        </div>
